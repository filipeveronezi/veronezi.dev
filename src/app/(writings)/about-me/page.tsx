  ...
  return (
    <>
      ...
      >
        ...
        <p>I&apos;ll explain.</p>
        <p>
          I&apos;ve studied programming for many years (I started when I was 15) and I was a <em>great student</em> who
          apparently would become a <em>great developer</em>. But even though my grades were good, I always felt
          something was <em>off</em>. I was trying hard to be a developer by making{' '}
          <span className="line-through">nonsensical</span> software with deep abstractions, complex architechtures, and
          logic.
        </p>
        <p>
          What I didn&apos;t realize at that time was that I just wasn&apos;t <em>building</em> something. Something
          that was <em>truly useful</em>.
        </p>
        <p>
          A developer doesn&apos;t exist to be a logic nerd who creates beautiful code only. A developer should actually
          be a <em>builder</em>. A builder of software that solves <em>real-life problems</em> and helps people in the
          most diversified ways.
        </p>
        <p>
